...
namespace System.Web.Mvc.Async.Benchmark
{
    public class AsyncControllerActionInvokerBenchmark
    {
        ...
        [Benchmark]
        public void AsyncControllerActionInvokerNew_BeginInvokeAction_NormalAction()
        {
            controllerContext.Controller = new TestController();
        ...
        [Benchmark]
        public async Task AsyncControllerActionInvokerNew_InvokeAction_NormalAction()
        {
            controllerContext.Controller = new TestController();
            AsyncControllerActionInvokerNew invoker = new AsyncControllerActionInvokerNew();
